...
Public Class rptStockStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BiruniSoft.StockControl.Reports.rptStockStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockStatus = New rptStockStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
